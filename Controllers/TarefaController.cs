...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            // Ja Feito !!!: Buscar  as tarefas no banco utilizando o EF, que contenha o status recebido por parâmetro
            // Dica: Usar como exemplo o endpoint ObterPorData
        ...
        public IActionResult Deletar(int id)
        {
            ...
            // Ja Feito: Remover a tarefa encontrada através do EF e salvar as mudanças (save changes)
